...
1. Start from the following sequence of values: `values <- seq(-5*pi, 5*pi, by = 0.01)` (a vector with values going from -5&#960; to 5&#960;, in steps of 0.01). Now do the following steps:
