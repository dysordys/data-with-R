...
The following plotting exercises use the Galápagos land snail data ([`island-FL.csv`](https://raw.githubusercontent.com/dysordys/data-with-R/main/data/island-FL.csv)).
