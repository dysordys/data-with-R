...
1. Download the data file `pop_growth_1.csv` from [this link](https://github.com/dysordys/data-with-R/tree/main/data), and load it in R.
...
1. Download the data file `pop_growth_2.csv` from [here](https://github.com/dysordys/data-with-R/tree/main/data), load it in R, and plot the population abundances against time.
