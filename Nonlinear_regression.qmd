...
The Q-Q plot is less than amazing. Otherwise, given that the data in fact depend on concentrations in a manifestly nonlinear way, the diagnostics look surprisingly good. We will come back to the point about nonlinearity in @sec-nonlin-regression.
