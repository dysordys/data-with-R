...
While the Q--Q plot could be better, there is not much reason not to trust the model---other than the fact, of course, that the data in fact depend on concentrations in a manifestly nonlinear way. We will come back to this point in @sec-nonlin-regression.
...
1. Download the data file [`pop_growth_1.csv`](https://raw.githubusercontent.com/dysordys/data-with-R/main/data/pop_growth_1.csv) and load it in R.
...
1. Download the data file [`pop_growth_2.csv`](https://raw.githubusercontent.com/dysordys/data-with-R/main/data/pop_growth_2.csv), load it in R, and plot the population abundances against time.
