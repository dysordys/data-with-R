...
The subsequent exercises use the Galápagos land snail data from the previous two chapters ([`island-FL.csv`](https://raw.githubusercontent.com/dysordys/data-with-R/main/data/island-FL.csv)).
